...
SECRET_KEY = 'django-insecure-2&lqt7yklg90&-3vphit##8&r4(1(bjd&$q=do4x53jf6l@2r@'
...
AUTO_LOGOUT = {
    ...
    'MESSAGE': 'La sesión ha expirado. Inicia sesión nuevamente para continuar.'
}
